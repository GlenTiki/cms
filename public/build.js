...
},{"moment":2,"react":176,"react-dom":5,"react-onclickoutside":4}],4:[function(require,module,exports){
/**
...
},{"react/lib/ReactDOM":55}],6:[function(require,module,exports){
...
},{"./lib/filterer":7,"./lib/is-empty":9,"./lib/leaf":11,"./lib/lens":12,"./lib/noop":13,"./lib/search-bar":14,"react":176}],7:[function(require,module,exports){
...
},{"./is-empty":9,"./is-primitive":10,"object-assign":20}],8:[function(require,module,exports){
var React = require('react');
...
},{"./type":15}],11:[function(require,module,exports){
var React = require('react');
var D = React.DOM;
...
},{"./highlighter":8,"./is-primitive":10,"./type":15,"./uid":16,"md5-o-matic":19,"react":176}],12:[function(require,module,exports){
var type = require('./type');
...
},{"./type":15}],13:[function(require,module,exports){
...
},{"./noop":13,"debounce":17,"react":176}],15:[function(require,module,exports){
...
var _prettyDebug = require('./prettyDebug.js');

var _prettyDebug2 = _interopRequireDefault(_prettyDebug);

var _eventEditor = require('./eventEditor.js');
...
var App = exports.App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      var that = this;
      request.get('/data').set('Accept', 'application/json').end(function (err, res) {
        that.setState({ results: res.body.results, original: res.body.results }, function () {
          if (that.state.results.length > 0) that.setState({ currentlyViewing: that.state.results[0].id });
        });
      });
    }
  }, {
    key: 'uploadSeminar',
    value: function uploadSeminar() {
      var _this2 = this;

      var original = this.state.original;

      var i = original.findIndex(function (e) {
        return e.id == _this2.state.currentlyViewing;
      });

      if (i > -1) original[i] = this.refs.editor.getValue();else original.push(this.refs.editor.getValue());

      var results = this.state.results;
      results[results.findIndex(function (e) {
        return e.id == _this2.state.currentlyViewing;
      })] = this.refs.editor.getValue();

      request.post('/data').send({ data: { results: original } }).set('Accept', 'application/json').end(function (err, res) {
        if (!err) this.setState({ original: res.body.results, results: results }, this.reload);
      }.bind(this));
    }
  }, {
    key: 'uploadAllSeminars',
    value: function uploadAllSeminars() {
      var _this3 = this;
      ...
      if (this.state.currentlyViewing > -1) // no need to update object which shouldn't exist
        results[results.findIndex(function (e) {
          return e.id == _this3.state.currentlyViewing;
        })] = this.refs.editor.getValue();

      request.post('/data').send({ data: { results: results } }).set('Accept', 'application/json').end(function (err, res) {
        if (!err) this.setState({ original: res.body.results, results: results }, this.reload);
      }.bind(this));
    }
  }, {
    ...
    value: function addMore() {
      ...
      var results = this.state.results; // immutable data must be copied to mutate
      if (this.state.currentlyViewing > -1) results[results.findIndex(function (e) {
        return e.id == _this4.state.currentlyViewing;
      })] = this.refs.editor.getValue();

      var nextId = 0;
      results.forEach(function (r) {
        return nextId = r.id + 1;
      });
    ...
    key: 'deleteSeminar',
    value: function deleteSeminar() {
      var _this5 = this;

      var nextId = -1;
      this.state.results.some(function (e) {
        if (e.id != _this5.state.currentlyViewing) {
          nextId = e.id;
          return true;
        }
      });
      var results = this.state.results;
      results.splice(this.state.results.findIndex(function (e) {
        return e.id == _this5.state.currentlyViewing;
      }), 1); //take it out
      this.setState({ results: results, currentlyViewing: nextId }, this.refs.prettyDebug.onDataChange);
    }
  }, {
    ...
    value: function onSelectChange(event) {
      ...
      var results = this.state.results;
      results[results.findIndex(function (e) {
        return e.id == _this6.state.currentlyViewing;
      })] = this.refs.editor.getValue();
    ...
    value: function render() {
      ...
      var chosenEvent = this.state.results.find(function (e) {
        return e.id == _this7.state.currentlyViewing;
      });
      return _react2.default.createElement(
        'div',
        null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'select',
              { value: this.state.currentlyViewing, onChange: this.onSelectChange.bind(this), className: 'input-group-field' },
              optionNodes
            ),
            _react2.default.createElement(
              'div',
              { className: 'input-group-button' },
              _react2.default.createElement('input', { type: 'submit', className: 'button', value: 'add another event', onClick: this.addMore.bind(this) })
            )
          ),
          this.state.currentlyViewing > -1 ? _react2.default.createElement(_eventEditor.EventEditor, { ref: 'editor', event: chosenEvent }) : _react2.default.createElement(
            'h2',
            null,
            ' Nothing to see here. try add a new event '
          ),
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { type: 'button', className: 'success button', style: { float: 'right' }, onClick: this.uploadAllSeminars.bind(this) },
              ' save all changes '
            ),
            this.state.currentlyViewing > -1 ? _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(
                'button',
                { type: 'button', className: 'success button', style: { float: 'right' }, onClick: this.uploadSeminar.bind(this) },
                ' save changes to this '
              ),
              _react2.default.createElement(
                'button',
                { type: 'button', className: 'alert button', style: { float: 'right' }, onClick: this.deleteSeminar.bind(this) },
                ' delete this seminar '
              )
            ) : false
          ),
          ...
          _react2.default.createElement('iframe', { src: '/cms', ref: 'testframe', style: { height: "600px", width: "100%", marginTop: '-13px' } })
        )
      );
    }
  }]);
...
},{"./eventEditor.js":184,"./prettyDebug.js":186,"./templateBuilder":187,"react":176,"superagent":177}],184:[function(require,module,exports){
'use strict';
...
var EventEditor = exports.EventEditor = function (_Component) {
  _inherits(EventEditor, _Component);

  function EventEditor(props) {
    _classCallCheck(this, EventEditor);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EventEditor).call(this, props));
  ...
  _createClass(EventEditor, [{
    ...
    value: function handleSubtitleChange(e) {
      var value = e.target.value;
      var next = this.state.event;
    ...
    key: 'addOverviewSection',
    value: function addOverviewSection() {
      var event = this.state.event;
      event.overview.data.push(createOverviewSection(event.overview.data.length));
      this.setState({ event: event });
    }
  }, {
    key: 'deleteOverviewSection',
    value: function deleteOverviewSection() {
      var event = this.state.event;
      if (event.overview.data.length > 2) event.overview.data.pop();
      this.setState({ event: event });
    }
  }, {
    key: 'handleOverviewMetaChange',
    value: function handleOverviewMetaChange(e) {
    ...
    value: function render() {
      ...
      var titleEditor = _react2.default.createElement(
        'label',
        null,
        'Title',
      ...
      var subtitleEditor = _react2.default.createElement(
        'label',
        null,
        'SubTitle',
        _react2.default.createElement('input', {
      ...
      var overviewNodes = _react2.default.createElement(
        'h4',
        null,
        'Nothing to see here. Click the + above to add more overview sections.'
      );
      if (overviewItems.length > 0) {
        overviewNodes = overviewItems.map(function (n, i) {
          var handleOverviewTextChange = function handleOverviewTextChange(e) {
            var next = n;
      ...
      var OfferingMetaNode = function OfferingMetaNode() {
        var changedColumns = function changedColumns(e) {
          var event = that.state.event;
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'select',
              { value: offeringMeta.columns, onChange: changedColumns, className: 'input-group-field' },
              _react2.default.createElement(
                'option',
                { value: 1 },
                '1'
      ...
      var offeringsNodes = _react2.default.createElement(
        'h4',
        null,
        'Nothing to see here!'
      );
      ...
      if (offeringsItems.length > 0) {
        offeringsNodes = offeringsItems.map(function (offering, i) {
          ...
          return _react2.default.createElement(
            ...
            'Display title: ',
            offering.lines[0].text,
            _react2.default.createElement(_reactDatepicker2.default, {
              selected: (0, _moment2.default)(offering.lines[0].text, "dddd Do MMMM YYYY"),
      ...
      var offeringsSection = _react2.default.createElement(
        'div',
        null,
        offeringMetaNode,
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { type: 'button', className: 'success button', style: { float: 'right' }, onClick: this.addOffering.bind(this) },
            ' + '
          ),
          _react2.default.createElement(
            'button',
            { type: 'button', className: 'alert button', style: { float: 'right' }, onClick: this.deleteOffering.bind(this) },
            ' - '
          ),
          _react2.default.createElement(
            'h3',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { type: 'button', className: 'success button', style: { float: 'right' }, onClick: this.addOverviewSection.bind(this) },
              ' + '
            ),
            _react2.default.createElement(
              'button',
              { type: 'button', className: 'alert button', style: { float: 'right' }, onClick: this.deleteOverviewSection.bind(this) },
              ' - '
            ),
            _react2.default.createElement(
              'h3',
              { style: { float: 'right' } },
              'Modify Overview Details:'
            )
          ),
          overviewNodes
        ),
...
},{"./templateBuilder":187,"moment":2,"react":176,"react-datepicker":3}],185:[function(require,module,exports){
'use strict';
...
ReactDOM.render(React.createElement(_app.App, null), document.getElementById('content'));

},{"./app.js":183,"react":176,"react-dom":5}],186:[function(require,module,exports){
'use strict';
...
exports.default = _react2.default.createClass({
    ...
    render: function render() {
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { style: this.headerStyle, onClick: this.toggle },
                _react2.default.createElement(
                    'strong',
                    null,
                    this.state.show ? "Click to hide state" : "Click to show state"
                )
            ),
            this.state.show ? _react2.default.createElement(Inspector, { data: this.props.data, search: false }) : false
        );
    }
});

},{"react":176,"react-json-inspector":6}],187:[function(require,module,exports){
"use strict";
  ...
  return {
    ...
    "organisation": {
      "meta": {
        ...
        "visible_also": ["visible_address1", "address2", "address3", "postcode", "county_region", "sectorNo", "contact_name", "telephone", "fax"]
      },
      "data": {
        "orgId": "",
        "name": "",
