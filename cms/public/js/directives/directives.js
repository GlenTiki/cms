...
genericApp.directive('contactdetailstemplate1', ['CloudServices','$compile', '$templateCache', 
  
     function(cloudServices, $compile, $templateCache) {
     
// a directive to allow a list of names to be edited
    var getTemplateUrl =  function() { return  "js/directives/templates/contactDetails_template1.html"; };
  ...
  return {
       ...
       templateUrl: "js/directives/templates/contactDetails_template1.html",
...
genericApp.directive('organisationdetailstemplate1', ['CloudServices','$compile', '$templateCache', 'OrganisationStateTemplate1','$templateRequest', '$q',
  
function(cloudServices, $compile, $templateCache,orgState, $templateRequest,$q) {
...
// a directive to allow a list of names to be edited
  ...
  return {
   ...
   //scope.globalReset =   scope.globalReset || 0;
	   scope.formMeta = {"organisationUIText" : scope.organisationUIText,
              ...
              // this was fulfilled aready
                 ...
                 //   if (deferred.promise.state == "fulfilled") return true;
                   ...
                   fieldsRequired = orgState.fn.setTemplateRequirements(scope.useTemplate);
                                 ...
                                 { // set the fields based on the template
                             ...
                             $templateRequest(orgState.formMeta.template).then(function(html){               
                                        ...
                                        }).catch(function(Res) {deferred.reject(Res);});
...
genericApp.directive('workshopattendees', ['CloudServices','$compile', '$templateCache',
  
     function(cloudServices, $compile, $templateCache) {
     
// a directive to allow a list of names to be edited
    var getTemplateUrl =  function() { return  "js/directives/templates/attendees/workshopattendees_template2.html"; };
  ...
  return {
        ...
        scope.$watch('globalReset()', function(newData,oldData){  // second pass has the data 
             // monitors the refresh of the parent and causes a refresh here also
                 ...
                 if (scope.attendees.length==0)
                                        {  // always have one blank attendee row
                                                var workshopsSlots = angular.copy(scope.workshopsMeta.data); // blank slots 
 
                                                scope.attendees.push({"lastname" : "",  "firstname" : "", "position" : "", 
   ...
   { // not dollar
        ...
        $scope.addAttendeeRow = function()
        {
            ...
            $scope.formData.attendees.push({"lastname" : "",  "firstname" : "", "position" : "", 
                                                "choices" :workshopsSlots} ); 
        }
...
genericApp.directive('seminarattendees', ['CloudServices','$compile', '$templateCache', 'ADStateTemplate1',
  
     function(cloudServices, $compile, $templateCache,adStateTemplate1) {
     
// a directive to allow a list of names to be edited
    var getTemplateUrl =  function() { return  "js/directives/templates/attendees/seminarattendees_template1.html"; };
 ...
 // Avoid memory leaks   http://roubenmeschian.com/rubo/?p=51
                 ...
                 scope.formMeta.currentEditTemp = {  "_meta_order": -1, "lastname":"", "firstname": "", "position":"", "lunch" : false};
                ...
                //      }    
                 // take the offerings and prepare them to be available in the selection/options choice.
                    ...
                    var preparedChoices     = scope._meta.offerings.data.filter(function(item) {        return item.visible==true })
                                                                        .map(function(item) {
   ...
   controller:   function($scope
    ...
    //  $scope.formMeta = adStateTemplate1.formMeta;
     ...
     $scope.addAttendeeRow = function(){        
                   ...
                   if ($scope.formMeta.currentEditTempIndex == -1)
                   {  // new entry
